...
public class StartupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        l1 = findViewById(R.id.buttonsetstart);
        connectmsg = findViewById(R.id.messageconnection);
        display2 = findViewById(R.id.msgstart);
                ...
                if(firebaseAuth.getCurrentUser()!=null) {
                    ...
                    if(connected){
                        if(prefs.getString("detailset","").equalsIgnoreCase("no")||prefs.getString("detailset","").equalsIgnoreCase("")) {
                            ...
                            Intent launchnewAcivity = new Intent(StartupActivity.this, SetupAccount.class);
                            launchnewAcivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            launchnewAcivity.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(launchnewAcivity);


                        }
                        else if(prefs.getString("detailset","").equalsIgnoreCase("yes")){
                            Intent launchnewAcivity = new Intent(StartupActivity.this, HomeActivity.class);
                            launchnewAcivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                            launchnewAcivity.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(launchnewAcivity);
                        }
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                        Toast.makeText(StartupActivity.this,"Something Went wrong! Please try again!",Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if(result.isSuccess()){
                ...
                Toast.makeText(StartupActivity.this,"Login Failed please check credentials",Toast.LENGTH_SHORT).show();
            }
        }
    }
